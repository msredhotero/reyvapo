...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_predio'], '../productos/');
//*** FIN  ****/
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->TraerProductos(),4);
